pub fn disassemble8080p(buffer: &Vec<u8>, pc: usize) -> usize {
    ...
    match op {
        0x00 => {println!("NOP");}
        0x01 => {println!("LXI      B, #${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0x02 => {println!("STAX     B");}
        0x03 => {println!("INX      B");}
        0x04 => {println!("INR      B");}
        0x05 => {println!("DCR      B");}
        ...
        0x0f => {println!("RRC");}
        0x10 => {println!("NOP");}
        0x11 => {println!("LXI      D, #${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0x12 => {println!("STAX     D");}
        0x13 => {println!("INX      D");}
        0x14 => {println!("INR      D");}
        0x15 => {println!("DCR      D");}
        ...
        0x1f => {println!("RAR");}
        0x20 => {println!("NOP");}
        0x21 => {println!("LXI      H, #${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0x22 => {println!("SHLD     ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0x23 => {println!("INX      H");}
        0x24 => {println!("INR      H");}
        0x25 => {println!("DCR      H");}
        ...
        0x28 => {println!("NOP");}
        0x29 => {println!("DAD      H");}
        0x2a => {println!("LHLD     ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0x2b => {println!("DCX      H");}
        0x2c => {println!("INR      L");}
        0x2d => {println!("DCR      L");}
        ...
        0x2f => {println!("CMA");}
        0x30 => {println!("NOP");}
        0x31 => {println!("LXI      SP, #${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0x32 => {println!("STA      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0x33 => {println!("INX      SP");}
        0x34 => {println!("INR      M");}
        0x35 => {println!("DCR      M");}
        ...
        0x38 => {println!("NOP");}
        0x39 => {println!("DAD      SP");}
        0x3a => {println!("LDA      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0x3b => {println!("DCX      SP");}
        0x3c => {println!("INR      A");}
        0x3d => {println!("DCR      A");}
        ...
        0xc0 => {println!("RNZ");}
        0xc1 => {println!("POP      B");}
        0xc2 => {println!("JNZ      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xc3 => {println!("JMP      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xc4 => {println!("CNZ      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xc5 => {println!("PUSH     B");}
        0xc6 => {println!("ADI      #${:02x}", buffer[pc+1]); opbytes=2;}
        0xc7 => {println!("RZ");}
        0xc8 => {println!("RST      0");}
        0xc9 => {println!("RET");}
        0xca => {println!("JZ       ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xcb => {println!("NOP");}
        0xcc => {println!("CZ       ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xcd => {println!("CALL     ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xce => {println!("ACI      #${:02x}", buffer[pc+1]); opbytes=2;}
        0xcf => {println!("RST      1");}
        0xd0 => {println!("RNC");}
        0xd1 => {println!("POP      D");}
        0xd2 => {println!("JNC      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xd3 => {println!("OUT      #${:02x}", buffer[pc+1]); opbytes=2;}
        0xd4 => {println!("CNC      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xd5 => {println!("PUSH     D");}
        0xd6 => {println!("SUI      #${:02x}", buffer[pc+1]); opbytes=2;}
        0xd7 => {println!("RST      2");}
        0xd8 => {println!("RC");}
        0xd9 => {println!("NOP");}
        0xda => {println!("JC       ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xdb => {println!("IN       #${:02x}", buffer[pc+1]); opbytes=2;}
        0xdc => {println!("CC       ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xdd => {println!("NOP");}
        0xde => {println!("SBI      #${:02x}", buffer[pc+1]); opbytes=2;}
        0xdf => {println!("RST      3");}
        0xe0 => {println!("RPO");}
        0xe1 => {println!("POP      H");}
        0xe2 => {println!("JPO      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xe3 => {println!("XTHL");}
        0xe4 => {println!("CPO      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xe5 => {println!("PUSH     H");}
        0xe6 => {println!("ANI      #${:02x}", buffer[pc+1]); opbytes=2;}
        0xe7 => {println!("RST      4");}
        0xe8 => {println!("RPE");}
        0xe9 => {println!("PCHL");}
        0xea => {println!("JPE      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xeb => {println!("XCHG");}
        0xec => {println!("CPE      ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xed => {println!("NOP");}
        0xee => {println!("XRI      #${:02x}", buffer[pc+1]); opbytes=2;}
        0xef => {println!("RST      5");}
        0xf0 => {println!("RPO");}
        0xf1 => {println!("POP      PSW");}
        0xf2 => {println!("JP       ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xf3 => {println!("DI");}
        0xf4 => {println!("CP       ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xf5 => {println!("PUSH     PSW");}
        0xf6 => {println!("ORI      #${:02x}", buffer[pc+1]); opbytes=2;}
        0xf7 => {println!("RST      6");}
        0xf8 => {println!("RM");}
        0xf9 => {println!("SPHL");}
        0xfa => {println!("JM       ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xfb => {println!("EI");}
        0xfc => {println!("CM       ${:02x}{:02x}", buffer[pc+2], buffer[pc+1]); opbytes=3;}
        0xfd => {println!("NOP");}
